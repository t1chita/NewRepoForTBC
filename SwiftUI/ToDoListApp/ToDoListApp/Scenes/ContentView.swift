...
struct ContentView: View {
    ...
    @State var incompletedCounter: CGFloat = 0
    @State var percent: CGFloat = 0
    @State var completeAllTask: () -> Void = {}
    var body: some View {
        ZStack {
            VStack {
                ...
                ScrollView {
                    ...
                    ListView(isAllTaskCompleted: $isAllTaskCompleted, completedCounter: $completedCounter, incompletedCounter: $incompletedCounter, percent: $percent, completeAllTask: $completeAllTask)
                        .frame(width: 400)
